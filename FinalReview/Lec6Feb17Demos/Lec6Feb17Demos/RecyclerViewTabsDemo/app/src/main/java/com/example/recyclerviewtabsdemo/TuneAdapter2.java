...
public class TuneAdapter2 extends RecyclerView.Adapter<TuneAdapter2.TuneViewHolder2> {
    ...
    public TuneAdapter2(List<Tune> tuneList) {TuneList = tuneList; }
    public List<Tune> getTuneList() {    return TuneList; }

    public void setTuneList(List<Tune> tuneList) {
        TuneList = tuneList;
         notifyDataSetChanged();}
    public int getCurrentPlayInd() {     return CurrentPlayInd;  }
    public void setCurrentPlayInd(int currentPlayInd) {
        CurrentPlayInd = currentPlayInd;
        notifyDataSetChanged();
    }
    @Override
    public TuneViewHolder2 onCreateViewHolder( ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder( TuneViewHolder2 holder, @SuppressLint("RecyclerView") int position) {
    ...
    @Override
    public int getItemCount() { return TuneList.size();  }
    public class TuneViewHolder2 extends RecyclerView.ViewHolder{
        ...
        public TuneViewHolder2(@NonNull View itemView) { super(itemView); }
    }
}
